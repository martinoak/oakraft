...
@section('content')
    ...
    <div class="relative isolate overflow-hidden px-6 pt-24 sm:pt-32 pb-12 lg:px-8" style="background-color: #212121;">
        ...
        <div class="mx-auto max-w-2xl text-center">
            <h2 class="text-5xl font-semibold tracking-tight text-white sm:text-7xl">Livery catalogue</h2>
            <p class="mt-8 text-pretty text-lg font-medium text-white sm:text-xl/8">Do you want to see all liveries? You are in the right place.</p>
        </div>
    </div>
                ...
                <div class="fixed inset-0 z-40 flex">
                    ...
                    <div class="relative ml-auto flex size-full max-w-xs flex-col overflow-y-auto bg-white pb-6 pt-4 shadow-xl">
                        <div class="flex items-center justify-between px-4">
                            ...
                            <button type="button" class="relative -mr-2 flex size-10 items-center justify-center rounded-md bg-white p-2 text-gray-400 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500">
